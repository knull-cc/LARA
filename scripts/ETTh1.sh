...
for pred_len in 96; do
  ...
  python -u run.py \
    --task_name long_term_forecast --is_training 1 \
    --data ETTh1 --root_path ./dataset/ETT-small/ --data_path ETTh1.csv --freq h \
    --model_id ETTh1_LARA_resmem_unionK500_${seq_len}_${pred_len} --model LARA_DLinear \
    --features M --seq_len $seq_len --label_len 48 --pred_len $pred_len \
    --enc_in 7 --dec_in 7 --c_out 7 \
    --e_layers 2 --d_layers 1 --factor 3 --d_model 512 --d_ff 512 \
    --des LARA_resmem_unionK500_ETTh1_96_ep15 --itr 1 --batch_size 32 --learning_rate 0.0003 \
    ...
    --lara_top_m 50 --lara_temperature 0.05 --lara_rank_temperature 0.05 \
    --lara_lambda_rank 0.8 --lara_lambda_pair 0.3 --lara_pair_margin 0.3 \
    --lara_lambda_score 0.2 --lara_score_loss corr --lara_lambda_sparse 0.001 \
    --lara_sparse_mode sparsemax --lara_score_mode horizon \
    --lara_candidate_source residual --lara_fusion residual_amp \
    --lara_max_amp 1.5 --lara_alpha_max 1.5 --lara_alpha_step 0.25 \
    --lara_gate_target alpha --lara_lambda_amp 2.0 --lara_lambda_risk 3.0 --lara_risk_margin 0.0 \
