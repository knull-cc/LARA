#!/usr/bin/env bash
# ETTh1 (7 variates, hourly). One-click scalar LARA_DLinear run.
extra_args="$@"
...
for pred_len in 96; do
  python -u run.py \
    ...
    --model_id ETTh1_LARA_sparsemax_gate5_pibrK300_${seq_len}_${pred_len} --model LARA_DLinear \
    --features M --seq_len $seq_len --label_len 48 --pred_len $pred_len \
    --enc_in 7 --dec_in 7 --c_out 7 \
    --e_layers 2 --d_layers 1 --factor 3 --d_model 512 --d_ff 512 \
    --des LARA_sparsemax_gate5_pibrK300_ETTh1_96_ep10 --itr 1 --batch_size 32 --learning_rate 0.0003 \
    ...
    --lara_sparse_mode sparsemax --lara_lambda_gate 5.0 \
